...
from .views import (
    ...
    TargetFuelView, MyCarView,  MyPageView, MyPageEditView, EcoCarSiteView, MyCarDetailView, PortfolioView,LogoutView
)
app_name = 'Edrive'
...
urlpatterns = [
    ...
    path('logout/',LogoutView.as_view(), name = 'logout'),  # ルート URL にアクセス時に PortfolioView を表示
]